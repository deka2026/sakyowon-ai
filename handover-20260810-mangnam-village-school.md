...
## 정리해 루틴 결과 (2026-08-10)
- ① 핸드오버: 본 문서 (f36884a)
- ② 스킬: `skills/hwp-binary-extract/` 신규 — 구형 .hwp OLE 텍스트 추출, 스모크 테스트 통과, 활성 폴더 복사 완료 (b491482)
- ③ 레슨: 「서버 없는 마을 홈페이지에 신청접수 기능 만들기」 (실천기술, author 김일영)
- ④ 위키배포: **PR #12 머지 완료** (sha 5caa1b5), 편지함 배포요청 발송 (d904905). 라이브는 본부 대기 — #10·#11도 아직 404

## 미완료 / 다음 할 일
- [ ] **위키 라이브 확인 대기**: PR #10·#11·#12 셋 다 wiki.poomasi.org에서 404 — 지미 배포 후 URL 확인 (완료 정의 = 라이브)
